if status is-interactive
    ...
    ~/.config/fish/scripts/startup_monet.sh
...
# User abbreviations
abbr -a -g ytmp3 'yt-dl --extract-audio --audio-format mp3'         # Convert/Download YT videos as mp3
...
# Created by `pipx` on 2023-10-25 15:28:10
